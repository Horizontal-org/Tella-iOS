...
extension TellaDataBase {
    ...
    func deleteAllServers() -> Result<Bool,Error> {
        do {
            try statementBuilder.deleteAll(tableNames: [D.tServer, D.tReport, D.tReportInstanceVaultFile, D.tUwaziServer, D.tUwaziTemplate, D.tResource, D.tGDriveServer, D.tGDriveReport, D.tGDriveInstanceVaultFile, D.tNextcloudServer, D.tNextcloudReport, D.tNextcloudInstanceVaultFile])

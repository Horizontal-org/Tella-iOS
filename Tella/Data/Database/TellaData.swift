...
class TellaData : ObservableObject {
    ...
    func addResource(resource: Resource, serverId: Int, vaultFileId: String) -> Void {
        let _ = database.addDownloadedResource(resource: resource, serverId: serverId, vaultFileId: vaultFileId)
    }

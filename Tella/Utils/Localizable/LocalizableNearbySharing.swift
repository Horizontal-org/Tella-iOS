...
enum LocalizableNearbySharing: String, LocalizableDelegate {
    ...
    case exitProgressSheetTitle = "NearbySharing_ExitProgress_SheetTitle"
    case exitProgressSheetExpl = "NearbySharing_ExitProgress_SheetExpl"
    case exitProgressExitAction = "NearbySharing_ExitProgress_Exit_Action"
    ...
    case recipientConnectionFailedExpl = "NearbySharing_Recipient_ConnectionFailed_SheetExpl"

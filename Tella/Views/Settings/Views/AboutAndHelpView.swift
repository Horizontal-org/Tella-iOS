//
//  AboutAndHelpView.swift
//  Tella
//
//  Created by Amine Info on 27/1/2022.
    ...
    var body: some View {
        ContainerView {
            VStack() {
                ...
                Text("\(LocalizableSettings.version.localized) \(Bundle.main.versionNumber)")
        ...
        .toolbar {
            LeadingTitleToolbar(title: LocalizableSettings.aboutAndHelp.localized)
        }
    }
}
